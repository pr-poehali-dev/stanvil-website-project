...
export const HOUSE_PROJECTS = [
  ...
  },
  {
    ...
    specs: ["Дом построен, готов к просмотру", "Кухня-гостиная со вторым светом 33.2 м²", "Крытая терраса 18 м²", "Открытая терраса 34.5 м²", "Без отделки", "Все коммуникации", "Благоустроенный участок 12 соток"],
  },
  {
    name: "«Микея 5»",
    area: "208.7 м²",
