...
export const HOUSE_PROJECTS = [
  {
    ...
    renders: [
      ...
      "https://cdn.poehali.dev/projects/8ca9811b-8e00-48a5-b9c5-c37bfe54bf8b/bucket/e4818de1-c234-4c26-baf3-89ab1f51bf1b.jpg",
      "https://cdn.poehali.dev/projects/8ca9811b-8e00-48a5-b9c5-c37bfe54bf8b/bucket/c31cba40-10bc-4ff4-a559-c672b58935ca.jpg",
      "https://cdn.poehali.dev/projects/8ca9811b-8e00-48a5-b9c5-c37bfe54bf8b/bucket/298b7c51-62a2-4bfc-b279-b9e708e7fdb6.jpg",
    ],
    plan: "https://cdn.poehali.dev/projects/8ca9811b-8e00-48a5-b9c5-c37bfe54bf8b/bucket/9bdbd6c1-54ee-408a-b62f-22f282861e68.jpg",
    specs: ["Дом построен, готов к просмотру", "Кухня-гостиная 37.7 м²", "Терраса 16.9 м²", "Без отделки", "Все коммуникации", "Благоустроенный участок 12 соток"],
  },
  {
    name: "«Микея 3»",
    area: "148.2 м²",
    ...
    specs: ["Дом построен, готов к просмотру", "Кухня-гостиная со вторым светом 33.2 м²", "Крытая терраса 18 м²", "Открытая терраса 24.5 м²", "Без отделки", "Все коммуникации", "Благоустроенный участок 12 соток"],
  },
  {
    name: "«Микея 5»",
    area: "208.7 м²",
    ...
    specs: ["Дом построен, готов к просмотру", "Кухня-гостиная с вторым светом 44.5 м²", "Крытая терраса 21.9 м²", "Открытая терраса 52.6 м²", "Без отделки", "Все коммуникации", "Благоустроенный участок 12 соток"],
  },
  {
    name: "«Альконт»",
    area: "216.3 м²",
    ...
    specs: ["Дом построен, готов к просмотру", "Гостиная-кухня 43.7 м²", "Терраса 22.7 м²", "Гараж + навес 30.1 / 36.6 м²", "Без отделки", "Все коммуникации", "Благоустроенный участок 12 соток"],
  },
  {
    name: "«Прайм»",
    area: "189.1 м²",
    ...
    specs: ["Дом построен, готов к просмотру", "Крытая терраса 11.7 м²", "Кухня-гостиная со вторым светом 52.3 м²", "Гараж на 2 авто 37.4 м²", "Без отделки", "Все коммуникации", "Благоустроенный участок 12 соток"],
  },
  {
    name: "«Гестола»",
    area: "136.8 м²",
    ...
    specs: ["Кухня-гостиная 43.4 м²", "Крытая терраса 9.9 м²", "Без отделки", "Все коммуникации", "Благоустроенный участок 12 соток", "Дом на стадии строительства", "Сдача в 4 кв. 2026 года"],
  },
  {
    name: "«Алхон»",
    area: "156.2 м²",
    ...
    specs: ["Кухня-гостиная 45.3 м²", "Крытая терраса 22.1 м²", "Гараж 22.7 м²", "Без отделки", "Все коммуникации", "Благоустроенный участок 12 соток", "Дом на стадии строительства", "Сдача в 4 кв. 2026 года"],
  },
  {
    name: "«Премьер»",
    area: "192.5 м²",
    ...
    specs: ["Кухня-гостиная с вторым светом 49.9 м²", "Крытая терраса 15.4 м²", "3 спальни + кабинет 11.2 м²", "Гардероб", "Без отделки", "Все коммуникации", "Благоустроенный участок 12 соток", "Дом на стадии строительства", "Сдача в 4 кв. 2026 года"],
  },
  {
    name: "«Павловы озёра»",
    area: "166.5 м²",
    ...
    style: "Классический",
    renders: [
      "https://cdn.poehali.dev/projects/8ca9811b-8e00-48a5-b9c5-c37bfe54bf8b/bucket/893cdeb9-68f1-4dde-8c81-0853d7f892f0.jpg",
      "https://cdn.poehali.dev/projects/8ca9811b-8e00-48a5-b9c5-c37bfe54bf8b/bucket/911ac772-3b5b-4546-b5f0-0f6b9e16f47a.jpg",
      "https://cdn.poehali.dev/projects/8ca9811b-8e00-48a5-b9c5-c37bfe54bf8b/bucket/4843645a-f363-43b9-b351-db86aca20fca.jpg",
      "https://cdn.poehali.dev/projects/8ca9811b-8e00-48a5-b9c5-c37bfe54bf8b/bucket/b1cbd7fc-b732-4654-9d70-1c43b6aca236.jpg",
      "https://cdn.poehali.dev/projects/8ca9811b-8e00-48a5-b9c5-c37bfe54bf8b/bucket/b8807a97-3015-4557-97e2-f70a00a7be9b.jpg",
    ],
    plan: "https://cdn.poehali.dev/projects/8ca9811b-8e00-48a5-b9c5-c37bfe54bf8b/bucket/e9b5a663-d03d-45e1-bb80-b519b6cf1491.jpg",
    specs: ["Кухня-гостиная 37.6 м²", "Крытая терраса 16.9 м²", "Без отделки", "Все коммуникации", "Благоустроенный участок 12 соток", "Дом на стадии строительства", "Сдача в 4 кв. 2026 года"],
  },
  {
    name: "«Гарден»",
    area: "188.5 м²",
    ...
    specs: ["Кухня-гостиная 41.9 м²", "Зимний сад / библиотека 10.2 м²", "Крытая терраса 44.8 м²", "2 спальни + кабинет", "Без отделки", "Все коммуникации", "Благоустроенный участок 12 соток", "Дом на стадии строительства", "Сдача в 4 кв. 2026 года"],
  },
];
...
export const PLOT_STATUS_LABEL: Record<PlotStatus, string> = {
  ...
  sale: "Свободный участок 12 соток, все коммуникации, продажа от 3 000 000 р",
...
export const MAP_PINS = [
  ...
  },
  {
    ...
    icon: "TreePine",
    title: "Лесная зона",
    desc: "Смешанный лес вокруг посёлка",
    x: 55,
    y: 97,
  },
  {
