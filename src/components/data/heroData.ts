...
export const HOUSE_PROJECTS = [
  ...
  },
  {
    ...
    specs: ["Дом построен, готов к просмотру", "Кухня-гостиная 33.2 м²", "Крытая терраса 18 м²", "Открытая терраса 34.5 м²", "Черновая отделка", "Все коммуникации", "Участок 12 соток"],
  },
  {
    name: "«Микеа 5»",
    area: "208.7 м²",
