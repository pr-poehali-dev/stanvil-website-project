...
export const HOUSE_PROJECTS = [
  {
    ...
    specs: ["Дом построен, готов к просмотру", "Крытая терраса 11.7 м²", "Кухня-гостиная 52.3 м²", "Гараж на 2 авто 37.4 м²", "4 спальни + санузлы", "Черновая отделка", "Все коммуникации", "Участок 12 соток"],
  },
  {
    name: "«Альконт»",
    area: "216.3 м²",
    ...
    specs: ["Дом построен, готов к просмотру", "Гостиная-кухня 43.7 м²", "Терраса 22.7 м²", "Гараж + навес 30.1 / 36.6 м²", "3 спальни + санузел", "Черновая отделка", "Все коммуникации", "Участок 12 соток"],
  },
  {
    name: "«Дакота»",
    area: "122.6 м²",
    ...
    specs: ["Дом построен, готов к просмотру", "Кухня-гостиная 37.7 м²", "Терраса 16.9 м²", "3 спальни + санузел", "Черновая отделка", "Все коммуникации", "Участок 12 соток"],
  },
  {
    name: "«Микеа 3»",
    area: "158.2 м²",
    ...
    specs: ["Дом построен, готов к просмотру", "Кухня-гостиная 33.2 м²", "Крытая терраса 18 м²", "Открытая терраса 34.5 м²", "3 спальни + 2 санузла", "Черновая отделка", "Все коммуникации", "Участок 12 соток"],
  },
  {
    name: "«Микеа 5»",
    area: "208.7 м²",
    ...
    specs: ["Дом построен, готов к просмотру", "Кухня-гостиная с вторым светом 44.5 м²", "Крытая терраса 21.9 м²", "Открытая терраса 52.6 м²", "3 спальни + 2 санузла", "Черновая отделка", "Все коммуникации", "Участок 12 соток"],
  },
  {
    name: "«Озёрный»",
    area: "166.5 м²",
