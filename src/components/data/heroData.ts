...
export const HOUSE_PROJECTS = [
  {
    ...
    specs: ["Дом построен, готов к просмотру", "Кухня-гостиная 37.7 м²", "Терраса 16.9 м²", "Без отделки", "Все коммуникации", "Участок 12 соток"],
  },
  {
    name: "«Микеа 3»",
    area: "158.2 м²",
    ...
    specs: ["Дом построен, готов к просмотру", "Кухня-гостиная со вторым светом 33.2 м²", "Крытая терраса 18 м²", "Открытая терраса 34.5 м²", "Без отделки", "Все коммуникации", "Участок 12 соток"],
  },
  {
    name: "«Микеа 5»",
    area: "208.7 м²",
    ...
    specs: ["Дом построен, готов к просмотру", "Кухня-гостиная с вторым светом 44.5 м²", "Крытая терраса 21.9 м²", "Открытая терраса 52.6 м²", "Без отделки", "Все коммуникации", "Участок 12 соток"],
  },
  {
    name: "«Альконт»",
    area: "216.3 м²",
    ...
    specs: ["Дом построен, готов к просмотру", "Гостиная-кухня 43.7 м²", "Терраса 22.7 м²", "Гараж + навес 30.1 / 36.6 м²", "Без отделки", "Все коммуникации", "Участок 12 соток"],
  },
  {
    name: "«Прайм»",
    area: "189.1 м²",
    ...
    specs: ["Дом построен, готов к просмотру", "Крытая терраса 11.7 м²", "Кухня-гостиная со вторым светом 52.3 м²", "Гараж на 2 авто 37.4 м²", "Без отделки", "Все коммуникации", "Участок 12 соток"],
  },
  {
    name: "«Гестола»",
    area: "136.8 м²",
    ...
    specs: ["Кухня-гостиная 43.4 м²", "Крытая терраса 9.9 м²", "Без отделки", "Все коммуникации", "Участок 12 соток", "Дом на стадии строительства", "Сдача в 4 кв. 2026 года"],
  },
  {
    name: "«Алхон»",
    area: "156.2 м²",
    ...
    specs: ["Кухня-гостиная 45.3 м²", "Крытая терраса 22.1 м²", "Гараж 22.7 м²", "Без отделки", "Все коммуникации", "Участок 12 соток", "Дом на стадии строительства", "Сдача в 4 кв. 2026 года"],
  },
  {
    name: "«Премьер»",
    area: "192.5 м²",
    ...
    specs: ["Кухня-гостиная с вторым светом 49.9 м²", "Крытая терраса 15.4 м²", "3 спальни + кабинет 11.2 м²", "Гардероб", "Без отделки", "Все коммуникации", "Участок 12 соток", "Дом на стадии строительства", "Сдача в 4 кв. 2026 года"],
  },
  {
    name: "«Павловы озёра»",
    area: "166.5 м²",
    ...
    specs: ["Кухня-гостиная 37.6 м²", "Крытая терраса 16.9 м²", "Без отделки", "Все коммуникации", "Участок 12 соток", "Дом на стадии строительства", "Сдача в 4 кв. 2026 года"],
  },
  {
    name: "«Гарден»",
    area: "188.5 м²",
    ...
    specs: ["Кухня-гостиная 41.9 м²", "Зимний сад / библиотека 10.2 м²", "Крытая терраса 44.8 м²", "2 спальни + кабинет", "Без отделки", "Все коммуникации", "Участок 12 соток", "Дом на стадии строительства", "Сдача в 4 кв. 2026 года"],
  },
];
