...
export const HOUSE_PROJECTS = [
  {
    ...
    specs: ["Дом построен, готов к просмотру", "Крытая терраса 11.7 м²", "Кухня-гостиная 52.3 м²", "Гараж на 2 авто 37.4 м²", "Черновая отделка", "Все коммуникации", "Участок 12 соток"],
  },
  {
    name: "«Альконт»",
    area: "216.3 м²",
